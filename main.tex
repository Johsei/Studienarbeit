...
{\includegraphics[height=1.7cm]{logo.jpg}} &
{\includegraphics[height=1.05cm]{blank.pdf}} &
{\includegraphics[height=1.7cm]{dhbw.pdf}}
\end{longtable}
% \enlargethispage{20mm}
\bigskip
\bigskip
\begin{center}
\vspace*{12mm} {\LARGE\bf Implementierung von Bilderkennung auf einem Mikrocomputer}\\
\vspace*{12mm} % {\large\bf Praxisarbeit des zweiten Studienjahres}\\
\vspace*{3mm} {\large\bf Studienarbeit}\\
\vspace*{12mm} des Studiengangs Elektrotechnik/Nachrichtentechnik\\ an der Dualen Hochschule Baden-Württemberg Stuttgart\\
% \vspace*{3mm} an der Dualen Hochschule Baden-Württemberg\\
\vspace*{12mm} von\\
\vspace*{3mm} {\large\bf Johannes Seidel}\\
\vspace*{12mm} 22.05.2021\\
\end{center}
\vfill
\begin{spacing}{1.5}
\begin{tabbing}
mmmmmmmmmmmmmmmmmmmmmmmmmm \= \kill
\textbf{Bearbeitungszeitraum} \> 30 Wochen\\
\textbf{Matrikelnummer, Kurs} \> 7160198, TEL18GR1\\
\textbf{Ausbildungsunternehmen} \> Tesat, Backnang\\
\textbf{Betreuer} \> Robert Mahn\\
...
\label{subsec:kap}
Wie Sie in \autoref{fig:logo} sehen: 
\begin{figure}[h]
  \centering
  \includegraphics[height=5.0cm]{companylogo}
  \caption[Beschreibung im Verzeichnis]{Grandioses Bild!\footnotemark}
  \label{fig:logo}
\end{figure}
